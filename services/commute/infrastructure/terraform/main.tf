resource "google_cloud_run_v2_service" "default" {
  ...
  template {
    containers {
      name = "envoy-sidecar"
      image = "us-south1-docker.pkg.dev/home-search-475404/homesearch-services-docker/commute-envoy:605dbabd"
      ports {
        name = "h2c"
        container_port = 8080
      }
    ...
    containers {
      name = "service"
      image = "us-south1-docker.pkg.dev/home-search-475404/homesearch-services-docker/commute:37046c3f"
      /*
      ports {
        name           = "h2c"
        container_port = 8080
